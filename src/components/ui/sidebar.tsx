...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="sidebar-hidden-md md:block"
        data-state={state}
      ...
      >
        ...
        state === "collapsed" && collapsible === "icon" && "sidebar-collapsed-icon",
        variant === "floating" && "sidebar-floating",
        variant === "inset" && "sidebar-inset",
          )}
        />
        <div
          className={cn(
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("sidebar-trigger-button", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
